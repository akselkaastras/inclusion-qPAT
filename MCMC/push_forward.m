function [xinterp,w,gamma] = push_forward(cn,prior_par)
...
N = prior_par.N; % number of active fourier coefficients
Ninterp = prior_par.Ninterp; % total number of fourier coefficients
...
% Function in periodic basis (1,cos(2pix),sin(2pix),cos(2pix),sin(2pix),...
w = ifft(b);
w = real(w) + imag(w);
